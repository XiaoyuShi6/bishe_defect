...
def evaluate_one_image():
    train_dir = "/home/sxy/PycharmProjects/defect2/data/test"
    ...
    for num in range(len(train)):
        with tf.Graph().as_default():
            ...
            image_array = get_one_image(train,num)
            ...
            with tf.Session() as sess:
                ...
                if max_index==train_label[num] and max_index==0:
                    p_right=p_right+1
                if max_index == train_label[num] and max_index == 1:
                    d_right=d_right+1
    print(p_right)
    print(d_right)
